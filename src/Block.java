...
public class Block {
    ...
    public synchronized String computeMerkleRoot(ArrayList<String> lstItems) {
        ...
        MerkleNode oNode7 = new MerkleNode(); //merkle tree leaves

        oNode1.sHash = BlockchainUtil.generateHash(lstItems.get(0)); //lab3test
        oNode4.sHash = BlockchainUtil.generateHash(lstItems.get(1));
